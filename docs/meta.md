...
| `git_hash`                       | String   | No        | Git commit hash of current blocklet release               | Should be set by bundle tools                                                                          | TODO   |
|                                  |          |           |                                                           |                                                                                                        |        |
| `interfaces`                     |          |           |                                                           |                                                                                                        | Draft  |
...
| `service.upstreamPort`           | Number   | No        | The configuration interface of the blocklet               | Should point to an accessible URL when the blocklet is running                                         | TODO   |
|                                  |          |           |                                                           |                                                                                                        |        |
...
| `environment.secure`             | Boolean  | No        | Whether the config is secure                              |                                                                                                        | TODO   |
|                                  |          |           |                                                           |                                                                                                        |        |
